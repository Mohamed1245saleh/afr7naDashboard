  ...
  methods: {
    ...
    getDataFromApi (res = null) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const endpoint = (this.search.replace(/\s/g, '').length>0)?'api/admin/categories/search/' + this.search + '?category='+this.filterCategory :'admin/event?title=event&category=2'
