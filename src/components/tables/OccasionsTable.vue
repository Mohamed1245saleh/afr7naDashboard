  ...
  <div class="elevation-2">
    ...
    <v-toolbar flat color="white">
      ...
      <v-select
        ...
        flat
        dense
        :items="[{title_ar:'الدول', id:null},...categories]"
        item-text="title_ar"
        item-value="id"
      />
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-center">
          <img
            ...
            :src="`http://afr7na.com/${props.item.special_image}`"
            alt="ايقونة "
            title="صورة "
            width="50px"
            height="50px"
      ...
      <template slot="no-data">
        <v-alert :value="true" color="success" icon="warning" outline>لا توجد مناسبات</v-alert>
      </template>
    </v-data-table>
